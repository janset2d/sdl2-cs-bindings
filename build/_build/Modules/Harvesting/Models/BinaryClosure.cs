...
/// </para>
/// </summary>
public sealed record BinaryClosure(IReadOnlySet<FilePath> PrimaryFiles, IReadOnlyList<BinaryNode> Nodes, IReadOnlySet<string> Packages)
{
    ...
    public bool IsPrimaryFile(FilePath path) => PrimaryFiles.Contains(path);
}
