...
public enum PackageValidationCheckKind
{
    ...
    /// <summary>
    /// G21 — within-family native dependency emits bare minimum range (<c>x.y.z</c>),
    /// and cross-family dependencies preserve the expected inclusive lower bound.
    /// </summary>
    ...
    /// <summary>
    /// G55 — native package ships root <c>janset-native-metadata.json</c> and its content
    /// matches manifest/library/build invariants.
    /// </summary>
    NativeMetadataFileValid,

    /// <summary>
    /// G56 — satellite cross-family dependency declares explicit upper bound
    /// <c>&lt; (UpstreamMajor + 1).0.0</c>.
    /// </summary>
    SatelliteCrossFamilyUpperBound,

    /// <summary>
    /// G57 — README mapping table block between JANSET markers is current and byte-equivalent
    /// to generator output derived from manifest.
    /// </summary>
    ReadmeMappingTableCurrent,
