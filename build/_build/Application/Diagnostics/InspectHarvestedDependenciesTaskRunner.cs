...
using Build.Infrastructure.Tools.Tar;
using Cake.Common.IO;
using Cake.Core;
using Cake.Core.Diagnostics;
using Cake.Core.IO;

namespace Build.Application.Diagnostics;
...
/// </summary>
public sealed class InspectHarvestedDependenciesTaskRunner(
    ...
    ManifestConfig manifestConfig)
{
    ...
    public Task RunAsync(BuildContext context)
    {
        ...
        var platform = _runtimeProfile.PlatformFamily;
    ...
    {
        var specified = context.Vcpkg.Libraries;
    ...
    private static string ResolveOsKey(PlatformFamily platform, string rid)
    {
    ...
    private void InspectLibrary(LibraryManifest library, string rid, PlatformFamily platform, string osKey)
    {
    ...
    private void InvokePlatformScanner(string libraryName, PlatformFamily platform, FilePath primary)
    {
        switch (platform)
        {
