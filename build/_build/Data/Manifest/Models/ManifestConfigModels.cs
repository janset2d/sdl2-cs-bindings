...
public record ManifestConfig
{
    ...
    [JsonPropertyName("packaging_config")] public required PackagingConfig PackagingConfig { get; init; }
    [JsonPropertyName("runtimes")] public required IImmutableList<RuntimeInfo> Runtimes { get; init; }
    [JsonPropertyName("package_families")] public required IImmutableList<PackageFamilyConfig> PackageFamilies { get; init; }
    [JsonPropertyName("system_exclusions")] public required SystemArtefactsConfig SystemExclusions { get; init; }
    [JsonPropertyName("library_manifests")] public required IImmutableList<LibraryManifest> LibraryManifests { get; init; }
...
public record PackagingConfig
{
    ...
    [JsonPropertyName("core_library")] public required string CoreLibrary { get; init; }
}
...
public record PackageFamilyConfig
{
    ...
    [JsonPropertyName("managed_project")] public string? ManagedProject { get; init; }
    [JsonPropertyName("native_project")] public string? NativeProject { get; init; }
...
{
    [JsonPropertyName("windows")] public required WindowsSystemArtefacts Windows { get; init; }
    [JsonPropertyName("linux")] public required LinuxSystemArtefacts Linux { get; init; }
    [JsonPropertyName("osx")] public required OsxSystemArtefacts Osx { get; init; }
}

public record WindowsSystemArtefacts
{
    [JsonPropertyName("system_dlls")] public ImmutableList<string> SystemDlls { get; init; } = [];
}

public record LinuxSystemArtefacts
{
    [JsonPropertyName("system_libraries")] public ImmutableList<string> SystemLibraries { get; init; } = [];
}
...
public record LibraryManifest
{
    ...
    [JsonPropertyName("vcpkg_port_version")] public required int VcpkgPortVersion { get; init; }
...
public record PrimaryBinary
{
    ...
    [JsonPropertyName("patterns")] public required IImmutableList<string> Patterns { get; init; }
}
