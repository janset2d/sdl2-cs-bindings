...
namespace Build.Tests.Unit.Application.Publishing;
...
public sealed class PublishTaskRunnerTests
{
    ...
    public async Task RunAsync_Should_Throw_When_FeedUrl_Is_Empty()
    {
        ...
        var runner = new PublishTaskRunner(repo.CakeContext, repo.CakeContext.Log, repo.Paths, manifest, feedClient);
