...
namespace Build.Tests.Unit.Validation.Conventions;

public sealed class FamilyIdentifierConventionsTests
{
    [Test]
    ...
    public async Task ManagedPackageId_Should_Match_Canonical_Format(string familyIdentifier, string expected)
    {
    ...
    public async Task NativePackageId_Should_Match_Canonical_Format(string familyIdentifier, string expected)
    {
    ...
    public async Task VersionPropertyName_Should_Match_Canonical_Format(string familyIdentifier, string expected)
    {
    ...
    [Test]
    public async Task VersionPropertyName_Should_Align_With_Janset_Smoke_Props_Declarations()
    {
