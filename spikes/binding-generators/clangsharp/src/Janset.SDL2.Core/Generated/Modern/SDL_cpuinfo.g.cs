...
namespace SDL2
{
    internal static partial class SDLNative
    {
        ...
        public static partial nint SDL_SIMDAlloc([NativeTypeName("const size_t")] nuint len);

        [LibraryImport("SDL2")]
        [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
        [return: NativeTypeName("void*")]
        public static partial nint SDL_SIMDRealloc([NativeTypeName("void*")] nint mem, [NativeTypeName("const size_t")] nuint len);

        [LibraryImport("SDL2")]
        [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
        public static partial void SDL_SIMDFree([NativeTypeName("void*")] nint ptr);
    }
}
