...
Guidance for deciding when a private method should stay private and when it should become a named collaborator. Written for the build-host refactor but applies project-wide.
