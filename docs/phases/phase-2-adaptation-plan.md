...
**Status:** IN PROGRESS — ADR-003 implementation and CI/CD rewrite are landed; PA-2 behavioral validation closed 2026-04-26. Remaining work is the Phase 2b tail (remote artifact source, first prerelease publication path).
**Prerequisites:**
