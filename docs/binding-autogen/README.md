...
| 3 | [`../superpowers/specs/2026-05-16-binding-generator-unified-design.md`](../superpowers/specs/2026-05-16-binding-generator-unified-design.md) | Unified design spec — manifest-driven per-family generator, BindingModel + 6 categories, per-category emitters, validator wiring, cross-family type refs, output topology, 5 production-shape anchors. |
| 4 | [`../superpowers/plans/2026-05-17-binding-generator-unified-plan.md`](../superpowers/plans/2026-05-17-binding-generator-unified-plan.md) | Unified implementation plan — Phases 1 (docs) / 2A–2D (manifest + infrastructure) / 3A–3G (Preview → real shape + emitters + dual-emit + smoke). |
