...
Read [`../../superpowers/plans/2026-05-17-binding-generator-unified-plan.md`](../../superpowers/plans/2026-05-17-binding-generator-unified-plan.md) and start at Phase 1. The plan is task-by-task with explicit approval gates (🔒 markers on manifest.json edits; Rider handoff on Phase 3A mass rename). Approval gate is a hard rule: present each commit summary + proposed message to Deniz before committing. Skill `superpowers:subagent-driven-development` or `superpowers:executing-plans` is the recommended sub-skill.
...
| 2026-05-16 | [`../../superpowers/specs/2026-05-16-binding-generator-unified-design.md`](../../superpowers/specs/2026-05-16-binding-generator-unified-design.md) | **Active** unified design spec; supersedes 2026-05-14 architecture + 2026-05-15 local-output-loop specs. |
| 2026-05-17 | [`../../superpowers/plans/2026-05-17-binding-generator-unified-plan.md`](../../superpowers/plans/2026-05-17-binding-generator-unified-plan.md) | **Active** unified implementation plan; supersedes Stage 1 plan + local-output-loop plan. |
