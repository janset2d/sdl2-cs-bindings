...
> **ARCHIVED 2026-04-21.** This is a historical snapshot of `docs/phases/phase-2-adaptation-plan.md` as of 2026-04-15 (last amended 2026-04-18). Preserved for historical rationale:
>
> - **S1 Adoption Record** (2026-04-17 within-family exact-pin retirement with mechanical investigation notes)
> - **Stream A0** full description (exact-pin spike mechanism, now RETIRED)
> - **Stream A-risky "Historical Record"** (partial revert of Mechanism 3 csproj shape)
> - **ADR-001 Adoption Addendum** (D-3seg versioning rollout narrative)
> - **Strategy State Audit** (brief-vs-code gap analysis, 2026-04-17)
> - Closed / withdrawn PDs: PD-1 (resolved), PD-2 (withdrawn), PD-4 (closed), PD-6 (closed), PD-9 (closed), PD-11 (recorded), PD-12 (recorded)
>
> Current canonical adaptation plan: [../phases/phase-2-adaptation-plan.md](../phases/phase-2-adaptation-plan.md) — post-ADR-003 rewrite (2026-04-21). Post-ADR-003 baseline treats S1 adoption, ADR-001 adoption, and the retired streams as settled context, not as active amendment layers.
>
> Rationale for this archive: the pre-ADR-003 adaptation plan accumulated amendment-on-amendment historical layers (S1 record, retired streams preserved for traceability, SUPERSEDED amendments, multi-round PD closures). Reader signal-to-noise dropped below threshold. The rewritten active doc retains only current execution state + open PDs; this snapshot keeps the historical rationale accessible for future "why was decision X retired?" questions without burdening the active doc.
>
> No further updates to this file.
