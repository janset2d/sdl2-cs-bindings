...
- [ ] Stream A-risky: MinVer + exact-pin csproj rollout + structural lock (unblocked by A0; three coordinated changes in single pass — see [phases/phase-2-adaptation-plan.md](phases/phase-2-adaptation-plan.md))
